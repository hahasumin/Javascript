...
// equality - puzzler
console.log(0 == false); // true (false = 0, null, undefined, "", NaN)
...
// for loop, for (beginl condition; step)
for (i = 3; i > 0; i--) {
  console.log(`for: ${1}`);
}
...
// break, continue
// Q1. iterate from 0 to 10 and print only even n umbers (use continue)
